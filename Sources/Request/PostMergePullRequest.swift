...
public struct PostMergePullRequest: Request {
    ...
    public var path: String { "/rest/api/1.0/projects/\(stashProject)/repos/\(repository)/pull-requests/\(pullRequestId)/merge" }
    public var httpBody = Data?.none
    public var queryItems: [URLQueryItem] {
        [URLQueryItem(name: "version", value: "\(pullRequestVersion)")]
    }
}
